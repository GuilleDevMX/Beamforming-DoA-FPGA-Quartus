...
set_global_assignment -name EDA_TEST_BENCH_MODULE_NAME work.LOW_PASS_FIR_tb -section_id tb
...
if {[file exists $file_dir/LOW_PASS_FIR_coef_reload.txt]} {
  set_global_assignment -name EDA_TEST_BENCH_FILE $file_dir/LOW_PASS_FIR_coef_reload.txt -section_id tb -library work
}
if {[file exists $file_dir/LOW_PASS_FIR_coef_reload_rtl.txt]} {
  set_global_assignment -name EDA_TEST_BENCH_FILE $file_dir/LOW_PASS_FIR_coef_reload_rtl.txt -section_id tb -library work
}
set_global_assignment -name EDA_TEST_BENCH_FILE $file_dir/LOW_PASS_FIR_input.txt -section_id tb -library work

set_global_assignment -name EDA_TEST_BENCH_FILE $file_dir/LOW_PASS_FIR_tb.vhd -section_id tb -library work
