...
% ================================================================================
% Generated on: 05/04/2025 22:28:49
...
for j = 1:sx
    ...
    %
    file_name = ['LOW_PASS_FIR_input.txt'];
     ...
     % run this output through the model 
      for i =  1 : num_ch
        if(not(isempty(single_channel_data{i})))
          output_ch{i} = LOW_PASS_FIR_mlab(single_channel_data{i}, single_channel_bank{i});
  ...
  for j = 1: limit;
    ...
    file_name = ['LOW_PASS_FIR_model_output'];
