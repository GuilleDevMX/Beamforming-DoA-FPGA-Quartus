...
# ACDS 23.1 993 win32 2025.05.04.22:28:51
# ----------------------------------------
...
# ----------------------------------------
# If LOW_PASS_FIR is one of several IP cores in your
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "LOW_PASS_FIR"
}
...
alias com {
  ...
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS          "$QSYS_SIMDIR/LOW_PASS_FIR_rtl_core.vhd"                      
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS          "$QSYS_SIMDIR/LOW_PASS_FIR_ast.vhd"                           
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS          "$QSYS_SIMDIR/LOW_PASS_FIR.vhd"                               
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS          "$QSYS_SIMDIR/LOW_PASS_FIR_tb.vhd"                            
}
